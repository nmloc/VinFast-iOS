...
class CustomEventHandler: AmityEventHandler {
    ...
    override func createLiveStreamPost(
        ...
        #else
        print("To broadcast live stream, please install AmityUIKitLiveStream, see also `VinFast/INSTALLATION.md`")
        #endif
    ...
    override func openLiveStreamPlayer(from source: AmityViewController, postId: String, streamId: String) {
        ...
        #else
        print("To watch live stream, please install AmityUIKitLiveStream, see also `VinFast/INSTALLATION.md`")
        #endif
    }
}
