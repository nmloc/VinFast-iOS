...
struct NewJoinerPostComponent: AmityPostComposable {
    ...
    func getComponentCell(_ tableView: UITableView, at indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "AmityPostNewJoinerTableViewCell", for: indexPath) as! AmityPostNewJoinerTableViewCell
